...
<html>
    ...
    <body>
        <div id="divNotaPedido" title="Nueva Nota de Pedido">
            <form id="frmNotaPedido" name="frmNotaPedido" method="post" action="${pageContext.request.contextPath}/controller/pedidosController?method=1">
