...
<html>
    ...
    <body>
        <div class="formulario" style="width: 100%;"> 
            <div id="divModificarCliente" title="Cambios Cliente">
                <form id="frmModificarCliente" name="frmModificarCliente" method="post" action="${pageContext.request.contextPath}/controller/clienteController?method=3">
                        ...
                        <fieldset>
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" id="txtNoExterior" name="txtNoExterior" class="required" onkeypress="mayuscula(this);"/></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>
                                        <div id="divCreditos" style="display: none;">                                              
                                            <input type="radio" id="rdbCreditoM" name="rdbCreditoM" value="1" onclick="creditosModificarCliente();" /><span class="text-muted">Monetario</span>
                                            <input type="radio" id="rdbCreditoM" name="rdbCreditoM" value="2" onclick="creditosModificarCliente();"/><span class="text-muted">Contra Nota</span>
                                            <input type="radio" id="rdbCreditoM" name="rdbCreditoM" value="3" onclick="creditosModificarCliente();"/><span class="text-muted">Plazo</span>
                                ...
                                <tr>
                                    <td><select name="cboVendedor" id="cboVendedor">
                                            ...
                                            <c:forEach items="${vendedores}" var="vendedores" varStatus="status">
                                                <c:if test="${vendedores.visible == true && vendedores.externo == false}">
...
<div id="divMessageModificarCliente" title="Advertencia">
    <table>
        <tr>
