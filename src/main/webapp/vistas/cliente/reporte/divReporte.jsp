...
<html>
    ...
    <body>  
        <div id="divTipoReporte" title="Tipo Reporte">          
            <form id="frmReporteClientes" name="frmReporteClientes" method="post" action="${pageContext.request.contextPath}/controller/clienteController?method=9" target="_blank">
                <input type="hidden" id="txtIdAction" name="txtIdAction" value="${id}" />
                <input type="hidden" id="reportName" name="reportName" value="clientes" /> 
                <center>
                    <table>
                        <tr>
        ...
        <div id="errorReporteCliente" title="Error !!!">
            <table>
                <tr>
