...
<html>
    ...
    <body>
        <div class="formulario" style="width: 100%;"> 
            <div id="divAltaVendedor" title="Registro Vendedor">
                <form id="frmAltaVendedor" name="frmAltaVendedor" method="post" action="${pageContext.request.contextPath}/controller/vendedorController?method=1">
                        ...
                        <fieldset>
                            ...
                            <div id="divCreditos" style="display: none;">
                                <fieldset>
                                    ...
                                    <input type="radio" id="rdbCredito" name="rdbCredito" value="1" onclick="credito();" /><span class="text-muted">Monetario</span>
                                    <input type="radio" id="rdbCredito" name="rdbCredito" value="2" onclick="credito();"/><span class="text-muted">Contra Nota</span>
                                    <input type="radio" id="rdbCredito" name="rdbCredito" value="3" onclick="credito();"/><span class="text-muted">Plazo</span>
                                </fieldset>
                            </div>
