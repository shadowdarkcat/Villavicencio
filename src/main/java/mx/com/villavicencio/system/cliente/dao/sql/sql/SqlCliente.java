package mx.com.villavicencio.system.cliente.dao.sql.sql;
...
public class SqlCliente {
    ...
    public static final String CORREO_EMPRESA = "correoEmpresa";
    public static final String SITIO_WEB = "sitioWeb";
    ...
    public static final String CORREO1 = "correo1";
    public static final String CORREO2 = "correo2";
    public static final String CORREO3 = "correo3";
    public static final String TIPO_CREDITO = "tipoCredito";
    public static final String CANTIDAD_MONETARIA = "cantidadMonetaria";
